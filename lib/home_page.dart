...
import 'package:simple_bubble_trouble/ball.dart';
import 'package:simple_bubble_trouble/button.dart';
import 'package:simple_bubble_trouble/missile.dart';
import 'package:simple_bubble_trouble/player.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void startGame() {
    ...
    Timer.periodic(const Duration(milliseconds: 10), (timer) {
      ...
      // if the ball hits the left wall then change direction to left
